...
public class QNote extends EntityPathBase<Note> {
  ...
  public final com.emotionmusicnote.common.QBaseTime _super = new com.emotionmusicnote.common.QBaseTime(
      this);
  ...
  public final ListPath<com.emotionmusicnote.song.domain.Song, com.emotionmusicnote.song.domain.QSong> songs = this.<com.emotionmusicnote.song.domain.Song, com.emotionmusicnote.song.domain.QSong>createList(
      "songs", com.emotionmusicnote.song.domain.Song.class,
      com.emotionmusicnote.song.domain.QSong.class, PathInits.DIRECT2);
  ...
  public QNote(Class<? extends Note> type, PathMetadata metadata, PathInits inits) {
    ...
    this.user = inits.isInitialized("user") ? new com.emotionmusicnote.user.domain.QUser(
