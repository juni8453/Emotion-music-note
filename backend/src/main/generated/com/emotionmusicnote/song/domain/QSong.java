...
public class QSong extends EntityPathBase<Song> {
    ...
    private static final long serialVersionUID = 1828434347L;
    ...
    public final com.emotionmusicnote.note.domain.QNote note;
    ...
    public QSong(Class<? extends Song> type, PathMetadata metadata, PathInits inits) {
        ...
        this.note = inits.isInitialized("note") ? new com.emotionmusicnote.note.domain.QNote(forProperty("note"), inits.get("note")) : null;
    }
